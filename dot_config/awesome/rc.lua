...
beautiful.init("/home/ddomee/.config/awesome/theme.lua")
beautiful.icon_theme        = "Papirus-Dark"
beautiful.bg_normal         = "#282A36" --"#222D32"
beautiful.bg_focus          = "#44475A" --"#2C3940"
...
-- {{{ Helper functions TODO: Debug this shit!!
...
myexitmenu = {
		{ "lock", "/home/ddomee/.scripts/displays/lock.sh", "/usr/share/icons/Papirus-Dark/32x32/status/changes-prevent.svg" },
...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mywibox:setup {
        ...
        -- fs_widget({ mounts = {'/', '/home', '/mnt/Files', '/mnt/Everlasting'} }),
        { -- Right widgets
            layout = wibox.layout.fixed.horizontal,
						separator,
            mpdarc_widget,
  --          mpris_widget(),
            ...
            separator,
            weather_widget({
							api_key = '8cf588304b39ff7436e5c3d30e7c6e99',
							coordinates = {46.7864491, 18.6331859},
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift" }, "Tab", function () awful.screen.focus_relative( 1)  end, { description = "focus next screen" , group = "screen"}),
...
for i = 1, 9 do
    globalkeys = gears.table.join(globalkeys,
        ...
        {description = "view tag # on the next screen"..i, group = "screen"}),
        -- Toggle tag display.
        ...
        -- Move client to tag on the other screen.
        awful.key({ "Mod1", "Shift" }, "#" .. i + 9,
                ...
                {description = "move focused client to tag # on the next screen"..i, group = "screen"}),
...
awful.rules.rules = {
    ...
    { rule = { class = "Code - OSS"}, properties = { screen = 1, tag = "4"} },
    { rule = { class = "Waterfox" }, properties = { screen = 1, tag = "6" } },
    { rule = { class = "smplayer" }, properties = { screen = 1, tag = "5" } },
    { rule = { class = "mpv" }, properties = { screen = 1, tag = "5" } },
    { rule = { class = "Microsoft Teams - Preview"}, properties = { screen = 2, tag = "4" } },
    { rule = { class = "qBittorrent" }, properties = { screen = 2, tag = "6" } },
    { rule = { class = "qBittorrent", windows_type = "dialog" }, callback = function(c) awful.client.movetotag(tags[mouse.screen][awful.tag.getidx()], c) end },
...
awful.spawn.with_shell("~/.scripts/displays/nitrogen_bg_change.sh")
